    ...
    return (
        <ScrollView style={{backgroundColor: 'white'}}>
            <View style={styles.container}>
                ...
                <Text style={styles.textBody4}>Sign Up</Text>
                ...
                <Image 
                    ...
                    resizeMode="center" 
                    style={styles.image2} />
                    <Text style={[styles.textBody2, {color: 'blue'}]} onPress={() => props.navigation.navigate('SignUp')}> Passenger</Text>
                </View>
                </View>
                <View style={styles.container3}>
                <View style={{flexDirection: 'row', marginVertical: 5}}>
                <Image 
                    ...
                    resizeMode="center" 
                    style={styles.image2} />
                    <Text style={[styles.textBody3, {color: 'blue'}]} onPress={() => props.navigation.navigate('RiderSignUp')}> Driver</Text>
                </View>
                </View>
                </View>
                <View style={{flexDirection: 'row', marginVertical: 5}}>
